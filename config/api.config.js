...
module.exports = {
  ...
  // Default document library for https://s8rj.sharepoint.com/sites/grupo ("Shared Documents").
  // For a different library, use: /sites/{site-id}/drives/{drive-id}.
  driveApi: 'https://graph.microsoft.com/v1.0/sites/s8rj.sharepoint.com:/sites/grupo:/drive',
